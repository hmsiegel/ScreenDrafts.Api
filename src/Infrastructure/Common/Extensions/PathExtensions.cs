...
public static class PathExtensions
{
    ...
    private const string _currentDirectoryToken = ".";
    private const string _parentDirectoryToken = "..";
    ...
    public static string ResolvePath(string path)
    {
        ...
        foreach (var segment in tokenizer)
        {
            ...
            if (segment.Length == 0
                || segment.Equals(_parentDirectoryToken, StringComparison.InvariantCultureIgnoreCase)
                || segment.Equals(_currentDirectoryToken, StringComparison.InvariantCultureIgnoreCase))
            {
        ...
        foreach (var segment in tokenizer)
        {
            ...
            if (segment.Equals(_parentDirectoryToken, StringComparison.InvariantCultureIgnoreCase))
            {
            ...
            else if (!segment.Equals(_currentDirectoryToken, StringComparison.InvariantCultureIgnoreCase))
            {
